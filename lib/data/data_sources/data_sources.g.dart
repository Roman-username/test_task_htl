...
class _ServerAPI implements ServerAPI {
  ...
  @override
  Future<ListRoomsModel> getRooms(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ListRoomsModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ListRoomsModel.fromJson(_result.data!);
    return value;
  }
